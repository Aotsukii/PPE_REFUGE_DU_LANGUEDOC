                ...
                <div class="card card-image mt-5" style="background-image: url('./img/cats1.jpg');">
                    ...
                    <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
                        <div>
                            ...
                            <a class="btn btn-lg btn-default btn-rounded" href="./heberger_chat.php"><i class="fas fa-clone left"></i> Voir les chats à l'adoption</a>
                        </div>
                    </div>
                </div>
                <!-- Card -->
                    ...
                    <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
                        <div>
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat fugiat, laboriosam, voluptatem,
                                optio vero odio nam sit officia accusamus minus error nisi architecto nulla ipsum dignissimos.
                                Odit sed qui, dolorum!.</p>
                            <a class="btn btn-lg btn-default btn-rounded" href="./heberger_chien.php"><i class="fas fa-clone left"></i> Voir les chiens à l'adoption</a>
                        </div>
                    </div>
                </div>
                <!-- Card -->
